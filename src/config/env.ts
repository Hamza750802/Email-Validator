...
export const config: Config = {
  ...
  redis: {
    ...
    cacheTtlSeconds: getEnvInt('REDIS_CACHE_TTL_SECONDS', 3600, { min: 60, max: 86400 }), // 1 hour default
    throttleTtlSeconds: getEnvInt('REDIS_THROTTLE_TTL_SECONDS', 300, { min: 10, max: 3600 }), // 5 min default
  },

  smtp: {
    maxGlobalConcurrency: getEnvInt('SMTP_MAX_GLOBAL_CONCURRENCY', 10, { min: 1, max: 100 }),
    ...
    softRetryLimit: getEnvInt('SMTP_SOFT_RETRY_LIMIT', 2, { min: 0, max: 5 }),
    initialRetryDelayMs: getEnvInt('SMTP_INITIAL_RETRY_DELAY_MS', 5000, { min: 1000 }),
    retryBackoffFactor: getEnvFloat('SMTP_RETRY_BACKOFF_FACTOR', 3, { min: 1, max: 10 }),
    connectTimeoutMs: getEnvInt('SMTP_CONNECT_TIMEOUT_MS', 10000, { min: 1000, max: 60000 }),
